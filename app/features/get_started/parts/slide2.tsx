...
export default function Slide2({ onPress }: Props) {
  ...
  return (
    <ImageBackground
      ...
      source={ImagesConstants.backgrounds.intro.slide2}
    >
      <SafeAreaView>
        <Stack
          direction="column"
          ...
          <Stack direction="column" gap={hp(3)}>
            <Stack direction="column">
              <Typography type="h1" style={styles.title}>
                {i18n.t("intro_screen.step2.title.0")}
              </Typography>
              <Typography
                type="h1"
                style={[styles.title, styles.title_darkbule]}
              >
                {i18n.t("intro_screen.step2.title.1")}
              </Typography>
              <Typography type="h1" style={styles.title}>
                {i18n.t("intro_screen.step2.title.2")}
              </Typography>
              <Typography type="h1" style={styles.title}>
                {i18n.t("intro_screen.step2.title.3")}
              </Typography>
            </Stack>
            <Typography type="h1" style={styles.sub}>
              {i18n.t("intro_screen.step2.content")}
            </Typography>
            ...
            <Stack direction="row" gap={wp(3)}>
              ...
              >
                ...
                >
                  {i18n.t("intro_screen.step2.button")}
                </Typography>
              </Stack>
