...
export default function NavigationSafetyScreen() {
  ...
  const renderHeading = () => (
    <Stack style={styles.headingContainer} direction="column">
      ...
      >
        ...
        <Image
          source={ImagesConstants.icons.while_circle}
  ...
  const renderBlockNavigationImage = () => (
    <Stack style={styles.block} direction="row">
      <Animated.Image
        source={ImagesConstants.icons.direction}
        style={[styles.directionIcon, { opacity: blinkAnimation }]}
      />
      <Animated.Image
        source={ImagesConstants.icons.arrow}
        style={[styles.arrowIcon, { opacity: blinkAnimation }]}
      />
    </Stack>
  );
    ...
    <Stack style={styles.contentContainer} direction="column">
      ...
      >
        <Typography type="h1" style={[styles.title, styles.main]}>
          ...
          <Typography
            type="h1"
            style={[styles.title, styles.main, styles.opacity]}
          >
            {i18n.t("feature.NavigationSafetyScreen.distance")}
          </Typography>
        </Typography>
