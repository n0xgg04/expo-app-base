...
var _defaultHandleBar = require("../components/defaultHandleBar");
/**
 ...
 */
const convertHeight = (height, containerHeight, handleBarHidden) => {
  ...
  if (typeof height === 'number') {
    ...
    if (height >= containerHeight) {
      if (containerHeight === SCREEN_HEIGHT && !handleBarHidden) {
        _height = containerHeight - _defaultHandleBar.DEFAULT_HANDLE_BAR_DEFAULT_HEIGHT;
    ...
    // perform checks
    if (!height.endsWith('%') || height.length <= 1 || height.length > 4) throw errorMsg;
    ...
    if (containerHeight === SCREEN_HEIGHT && !handleBarHidden) {
      _height -= _defaultHandleBar.DEFAULT_HANDLE_BAR_DEFAULT_HEIGHT;
    }
  } else throw errorMsg;
  return _height;
};
var _default = exports.default = convertHeight;
